               ...
               <div class="row">
                 ...
                 <div class="col-md-4">
                   <div class="input-group">
                     ...
                     <input type="number" class="form-control" name="buying-price" placeholder="Bidding Price">
                  ...
                  <div class="col-md-4">
                    <div class="input-group">
                      ...
                      <input type="number" class="form-control" name="saleing-price" placeholder="Last Price">
                      <span class="input-group-addon">.00</span>
                   </div>
                  </div>
               </div>
